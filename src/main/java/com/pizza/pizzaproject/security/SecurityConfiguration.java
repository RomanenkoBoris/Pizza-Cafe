    ...
    public SecurityFilterChain getChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/pizzas/{id}").permitAll()
                                .requestMatchers(HttpMethod.POST, "/api/pizzas").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/pizzas/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/pizzas/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET, "/api/cafes").permitAll()
                                .requestMatchers(HttpMethod.GET, "/api/cafes/{id}").permitAll()
                                ...
                                .requestMatchers(HttpMethod.DELETE, "/api/cafes/{cafeId}/pizzas/{pizzaId}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/cafes/{cafeId}/pizzas/{pizzaId}").hasRole("ADMIN")
